...
class AerotechFormat():
    ...
    def makeTemplate():
        ...
        logo = image.imread(r'AerotechLogo.png', format='png') # Reading image into program
        ax0 = plt.subplot2grid((rows, cols), (0, 1), rowspan=1, colspan=1) # Establishing subplot number
